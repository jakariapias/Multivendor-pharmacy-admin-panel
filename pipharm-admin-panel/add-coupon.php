                              ...
                              <div class="row align-items-center">
                                ...
                                <div class="col-md-9">
                                  <div class="form-check user-checkbox ps-0">
                                    ...
                                    <label class="form-label-title mb-0">Enable the Coupon</label>
                                  </div>
                                </div>
                              </div>
                              <button type="submit" style="width:100px;" name="uploadCuponHome" class="btn ms-auto theme-bg-color text-white">Submit</button>
                            </div>
                          </form>
                        </div>
